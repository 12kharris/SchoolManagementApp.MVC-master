...
namespace SchoolManagementApp.MVC.Controllers
{
    public class CoursesController : Controller
    {
        ...
        {
            /*  Pseudo code for what the following is doing :
                If (db table exists)
            ...
            */
              ...
              return _context.Courses != null ? // check if table exists in db
                          View(await _context.Courses.ToListAsync()) : // gets records from the table and stores in list
